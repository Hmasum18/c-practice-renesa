...
public:
    ...
    // postfix increment
    UINT_32 operator++(int unused){
        Increment();
        return *this;
    }
    
    UINT_32 operator+(UINT_16 b){
        UINT_32 a(u, l);
        a.Add(b);
        return a;
    }
    
    UINT_32 operator+(UINT_32 b){
        UINT_32 a(u, l);
        a.Add(b);
        return a;
    }
...
public:
    ...
    UINT_64(UINT_16 a, UINT_16 b, UINT_16 c, UINT_16 d)
    {
        ...
        // cout<<"constructor saving: "<<bits<<endl;
        Set_bit_str(bits);
    }
    ...
    void set_c(UINT_16 c)
    {
        this->c = c;
    };

    void set_d(UINT_16 d)
    {
        this->d = d;
    };
    ...
    // postfix increment
    UINT_64 operator++(int unused)
    {
        Increment();
        return *this;
    }

    UINT_64 operator+(UINT_16 m)
    {
        UINT_64 n(a, b, c, d);
        n.Add(m);
        return n;
